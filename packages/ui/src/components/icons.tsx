...
export const Icons = {
  LogoSmall: (props: SVGIconProps) => (
    <SVGIcon size={28} {...props} viewBox="0 0 64 64">
      <path
        ...
        fill="none"
      />
      <circle cx="31" cy="29" r="6.5" fill="#009b98" />
    </SVGIcon>
  ),
  Logo: (props: any) => (
    <svg
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="12"
        transform="translate(0,2) scale(0.24)"
      />
      <circle cx="8.44" cy="9.36" r="1.56" fill="#009b98" />
      <text
        x="20"
        y="22"
        fill="currentColor"
